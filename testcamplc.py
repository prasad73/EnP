...
def liningcheck(img):
    ...
    line = [(285,876),(285,3644),(2962,3615),(2962,866),(186,2208),(3081,2208),(208,1600),(1592,728),(1592,3761),(3064,1600),(202,2928),(3058,2928),(960,744),(960,3744),(2268,775),(2268,3735)]
    noline = 0
    for row in line:
        x=row[1]
        y = row[0]
...
while camera.IsGrabbing():
    ...
    if grabResult.GrabSucceeded():
        ...
        if (lineStatus==True and checkflag==0):
            ...
            name="savedata/"+serial+".jpg"
            savedatetime=str(now.day)+str(now.month)+str(now.year)+"_"+str(now.hour)+"_"+str(now.minute)+"_"+str(now.second)+"m"+str(now.microsecond)
