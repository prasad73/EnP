    ...
    #fuse2 = img[1880:1880+240,2778:2778+536]
        if i==0:
            ...
            if(tag==False):
                print("panel error")
                stat2=False
            elif c1>=220 and '17' in (spec or spec2) and (x11,y11)!=(0,0):
                print("fuse detected and serial matched")
                stat2 = True
...
def liningcheck(img,tag):
    ...
    img2 = img2[:,:,1]
    line = [(285,876),(285,3610),(2962,3615),(2962,866),(200,2260),(3081,2208),(208,1600),(1592,728),(1592,3744),(3064,1600),(202,2928),(3058,2928),(960,744),(960,3744),(2268,775),(2268,3735)]
    noline = 0
    for row in line:
        x=row[1]
        y = row[0]
